...
popup_content <- paste0(
      ...
      "<div><p>Addr: ", df$address,"</p></div>",
      "<div> <img src='img/", df$img, "' style='max-width:300px'></div>",
      "<div><p style='overflow-y: scroll;max-height: 250px;'>", df$text, "</p></div>",
      "<div><audio controls><source src='audio/", df$audio, "' type='audio/mpeg'> Your browser does not support the audio element</audio></div>",
      df$soundcloud)
